...
import { getZeptoRedirectUri } from "./config";
...
export class KavachZeptoOAuthProvider implements OAuthClientProvider {
    ...
    get redirectUrl(): string {
        return getZeptoRedirectUri();
    }

    get clientMetadata(): OAuthClientMetadata {
        return {
            client_name: "Kavach Care Dashboard",
            redirect_uris: [getZeptoRedirectUri()],
